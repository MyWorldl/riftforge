...
- [ ] 1.8 — Interface com filtro por rota e elo — **próximo passo, agora é trabalho de API + frontend, não mais um job de pipeline**. Ver `Core/Estrutura_roadmap/17_ESTADO_IMPLEMENTADO.md` §9.
