...
class PatchNotesRepository:
    ...
    def get_two_latest_patches(self, elo_tier: str) -> list[str]:
    ...
    def list_scores(self, elo_tier: str, patch: str) -> list[ChampionScore]:
        return self.db.query(ChampionScore).filter_by(elo_tier=elo_tier, patch=patch).all()
