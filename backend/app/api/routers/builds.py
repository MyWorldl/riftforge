...
def get_recommended_build(
    champion_id: str, lane: str, elo_tier: str = "GOLD", patch: str | None = None, db: Session = Depends(get_db)
) -> dict | None:
    ...
    return build_service.get_recommended_build(db, champion_id, lane, elo_tier, patch)
